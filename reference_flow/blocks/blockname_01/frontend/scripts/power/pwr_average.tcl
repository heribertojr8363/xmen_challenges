...
# 0.4      2020-01-29  bruno.silva         Revised -Added the library of 1.2V
# -----------------------------------------------------------------------------
...
if { $POWER_MODE == "average"} {
   ...
   set_analysis_mode -analysisType single \
                     ...
                     -clockPropagation forcedIdeal \
                     -cppr setup \
                     -enableMultipleDriveNet true \
                     -sequentialConstProp false \
                     -skew false \
                     -timingEngine static 
   set_power_analysis_mode -method static -report_black_boxes true -honor_negative_energy true -create_binary_db true -binary_db_name StaticPower.db -write_static_currents true
   ...
   report_power -outfile $RPTDIR/${DESIGN}_pwr_analysis_${POWER_MODE}_${OP_COND}.rpt
}
